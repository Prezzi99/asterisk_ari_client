        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
          <div style={{ flex: '1 1 300px', minWidth: '0' }}>
            ...
            <p style={{ color: 'rgb(156, 163, 175)', fontSize: '0.875rem' }}>
              A list of all the agents who will be called when a lead selects the option to speak with an agent.
            </p>
          </div>
          <Link to="/agents/add">
            <button
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              <tr style={{ backgroundColor: 'transparent' }}>
                ...
                <th style={{ padding: '0.75rem 1.5rem', textAlign: 'left', fontSize: '0.75rem', fontWeight: '700', color: 'white', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                  Phone Number
                </th>
            ...
            <tbody>
              {users.map((user, index) => (
                <tr key={index} style={{ borderTop: '1px solid rgb(55, 65, 81)', backgroundColor: 'transparent' }}>
                  ...
                  <td style={{ padding: '1rem 1.5rem', fontSize: '0.875rem', color: 'rgb(156, 163, 175)' }}>
                    {editingId === user.id ? (
                      <input
                        type="text"
