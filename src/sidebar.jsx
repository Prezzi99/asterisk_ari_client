      ...
      <>
        ...
        >
          ...
          <div className="p-6 flex items-center justify-between">
            <span className="zentro-logo" style={{position: 'relative', bottom: '5px'}}>zentro</span>
            <div 
          ...
          <nav className="flex-1 px-4 py-2 space-y-1">
            <Link to="/attendants" onClick={() => setIsMobileMenuOpen(false)}>
            <button className="nav-button w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-colors text-left">
              ...
              <span className="text-sm font-medium" style={{letterSpacing: '-0.01em'}}>Auto Attendants</span>
            </button>
            </Link>

            <Link to="/lists" onClick={() => setIsMobileMenuOpen(false)}>
            <button className="nav-button w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-colors text-left">
              <FolderOpen className="w-5 h-5 shrink-0" />
              <span className="text-sm font-medium" style={{letterSpacing: '-0.01em'}}>Calling Lists</span>
            </button>     
            </Link>
          ...
          <div className="p-4">
            <button className="user-button w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors glassmorphism">
              ...
              <div className="flex-1 text-left">
                <div className="text-sm font-semibold text-white" style={{letterSpacing: '-0.01em'}}>My Account</div>
                <div className="text-xs" style={{color: '#71717a'}}>Beta 0.1.0</div>
              </div>
  ...
  return (
    ...
    >
      ...
      <div className={`p-6 flex items-center ${isCollapsed ? 'justify-center' : ''}`}>
        ...
        {!isCollapsed && <span className="zentro-logo ml-3" style={{position: 'relative', bottom: '5px'}}>zentro</span>}
      </div>
      ...
      <nav className="flex-1 px-4 py-2 space-y-0.5">
        ...
        <button className={`nav-button w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors text-left ${isCollapsed ? 'justify-center' : ''}`}>
          ...
          {!isCollapsed && <span className="text-sm font-medium nav-text" style={{letterSpacing: '-0.01em'}}>Calling Lists</span>}
        </button>
        </Link>
